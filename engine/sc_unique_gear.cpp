    ...
    const std::string& id)
{
    ...
    else if (name == "forge_ember") e = "OnSpellCastHit_115SP_10%_10Dur_45Cd";  // Triumvirate: 115 (down from retail 512)
    ...
    else if (name == "quagmirrans_eye") e = "OnSpellCast_192Haste_10%_6Dur_45Cd";  // Triumvirate: 192 (down from retail 320)
    ...
    else if (name == "meteorite_whetstone") e = "OnAttackHit_170Haste_15%_10Dur_45Cd";  // Triumvirate: 170 (down from retail 444); flat +18 crit rating is base item stat, not a proc
    else if (name == "spark_of_life") e = "OnSpellCast_105MP5_10%_15Dur_50Cd";    // Triumvirate: 105 (down from retail 220)
    ...
    else if (name == "pendulum_of_telluric_currents") e = "OnSpellHit_673Shadow_15%_45Cd";  // Triumvirate: 673 (down from retail avg ~1460); value = midpoint of tooltip's 485-860 range
